...
layui.define(['laytpl', 'laypage', 'layer', 'form','fsConfig'], function(exports){
  ...
  Class.prototype.pullData = function(curr, loadIndex){
    ...
    if(options.url && isLoad == "1"){ //Ajax请求
      ...
      console.log("dd=",$.extend(params, options.where))
      ...
      $.ajax({
        ...
        ,success: function(res){
          ...
          console.log("res =", $.result(res,response.statusName));
          ...
          loadIndex && layer.close(loadIndex);
          console.log("$.result(res,response.countName)=",$.result(res,response.countName))
